...
def parse_file(fname, edges, polygons, csystems, screen, color):
    ...
    while c < len(lines):
        ...
        if line == "sphere":
            ...
            add_sphere(polygons, *args, steps_3d)
            ...
            add_torus(polygons, *args, steps_3d)
            matrix_mult(csystems[-1], polygons)
            draw_polygons(polygons, screen, color)
            polygons = []
            ...
            add_circle(edges, *args, steps_2d)
            ...
            add_curve(edges, *args, steps_2d, line)
            matrix_mult(csystems[-1], edges)
            draw_lines(edges, screen, color)
            edges = []
